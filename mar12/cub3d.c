...
// TODO: check if this function should this function be more generic and return a pointer to a poitner of the first line first char and takes a char pointer as an argument
