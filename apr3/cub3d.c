...
// how does state work ?
// state needs to be initialize to BEFORE_MAP but how do we do it ?

t_config	init_config()
{
	t_config	config;
	config.has_floor = false;
	config.has_ceiling = false;
	config.floor_rgb[0] = 0;
	config.floor_rgb[1] = 0;
	config.floor_rgb[2] = 0;
